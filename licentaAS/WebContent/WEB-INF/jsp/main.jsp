       	...
       	<div class="slide right-slide">
       		...
       		<ul>
       			...
       			<c:if test="${hasWorkThreats}"> 
       				<li>Not create negative work related posts. Imagine your boss reading your facebook wall. Also employers are likely to check your facebook account before they call you in for an interview.</li>
       			</c:if>
       		</ul>
